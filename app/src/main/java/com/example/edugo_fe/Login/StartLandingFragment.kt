...
import com.example.edugo_fe.databinding.FragmentStartLandingBinding

class StartLandingFragment : Fragment() {
    private var _binding: FragmentStartLandingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStartLandingBinding.inflate(inflater, container, false)
